...
> **查看演示视频**：[点击播放 doc/demo.mp4](doc/demo.mp4) | [点击播放 游戏案例](https://www.bilibili.com/video/BV1AMDyBWEjY/)
...
1. **授予权限**：应用运行前必须手动开启“无障碍服务 (Accessibility Service)”以及“悬浮窗”权限，或者root权限，否则脚本无法模拟点击。
